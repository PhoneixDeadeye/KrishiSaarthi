        ...
        <header className="h-16 flex items-center justify-between px-4 md:px-8 bg-card/80 backdrop-blur-md border-b border-border sticky top-0 z-10">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="relative hidden md:block">
              ...
              <input
                className="w-64 pl-10 pr-4 py-2 bg-muted border-none rounded-full text-sm text-foreground focus:ring-2 focus:ring-primary/50 placeholder-muted-foreground"
