                ...
                <section className="py-20 md:py-32 px-4 md:px-10 max-w-[1440px] mx-auto w-full" id="features">
                    <div className="flex flex-col md:flex-row gap-12 items-start justify-between mb-16">
                        ...
                        <div className="flex items-end">
                            <a href="#features" className="group flex items-center gap-2 text-landing-primary font-bold hover:underline">
                                View all features
                ...
                <div className="px-4 md:px-10 max-w-[1440px] mx-auto">
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 mb-16">
                        <div className="lg:col-span-2">
                            ...
                            <div className="flex gap-4">
                                <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-gray-100 dark:bg-gray-800 flex items-center justify-center text-gray-600 dark:text-gray-400 hover:bg-landing-primary hover:text-black transition-colors">
                                ...
                                <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-gray-100 dark:bg-gray-800 flex items-center justify-center text-gray-600 dark:text-gray-400 hover:bg-landing-primary hover:text-black transition-colors">
                                ...
                                <a href="https://github.com" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-gray-100 dark:bg-gray-800 flex items-center justify-center text-gray-600 dark:text-gray-400 hover:bg-landing-primary hover:text-black transition-colors">
                    ...
                    <div className="border-t border-gray-100 dark:border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-gray-500 dark:text-gray-500">
                        ...
                        <div className="flex gap-6">
                            <span className="hover:text-landing-text-light dark:hover:text-white transition-colors cursor-pointer">Privacy Policy</span>
                            <span className="hover:text-landing-text-light dark:hover:text-white transition-colors cursor-pointer">Terms of Service</span>
                            <span className="hover:text-landing-text-light dark:hover:text-white transition-colors cursor-pointer">Cookie Settings</span>
                        </div>
                    </div>
                </div>
            </footer>
