...
class SeasonCalendar(models.Model):
    ...
    field = models.ForeignKey(
        FieldData, on_delete=models.CASCADE, related_name="calendar_events"
    )
...
class LaborEntry(models.Model):
    ...
    user = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name="labor_entries"
    )
    field = models.ForeignKey(
        FieldData, on_delete=models.CASCADE, related_name="labor_entries"
    )
...
class EquipmentBooking(models.Model):
    ...
    field = models.ForeignKey(
        FieldData, on_delete=models.CASCADE, related_name="equipment_bookings"
    )
    ...
    def __str__(self):
        return (
            f"{self.equipment.name} for {self.purpose} ({self.start_datetime.date()})"
        )
