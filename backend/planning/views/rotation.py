...
ROTATION_MATRIX = {
    ...
    "default": {"Pulses": 5, "Vegetables": 4, "Maize": 4, "Wheat": 4, "Rice": 3},
}
...
CROP_BENEFITS = {
    ...
    "Vegetables": {
        "nitrogen_fix": False,
        "soil_structure": "varies",
        "pest_break": True,
    },
    "Groundnut": {
        "nitrogen_fix": True,
        "soil_structure": "improves",
        "pest_break": True,
    },
...
class RotationPlannerView(APIView):
    ...
    def _build_rotation_timeline(self, current_crop, current_season):
        ...
        current_idx = (
            seasons_order.index(current_season)
            if current_season in seasons_order
            else 0
        )
