            ...
            breakdown_list = [
                {
                    ...
                    "percentage": (
                        float(item["total"] / total_costs * 100)
                        if total_costs > 0
                        else 0
                    ),
                }
            ...
            return Response(
                {
                    "summary": {
                        ...
                        "profit_margin": (
                            float(profit_margin) if profit_margin else None
                        ),
                        "is_profitable": profit_loss > 0,
                    },
                    "cost_breakdown": breakdown_list,
                    "revenue_by_crop": list(revenue_by_crop),
                    "filters": {"field_id": field_id, "season_id": season_id},
                }
            )
