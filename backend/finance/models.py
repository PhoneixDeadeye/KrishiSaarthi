...
class Season(models.Model):
    ...
    field = models.ForeignKey(
        FieldData, on_delete=models.CASCADE, related_name="seasons"
    )
...
class CostEntry(models.Model):
    ...
    season = models.ForeignKey(
        Season, on_delete=models.SET_NULL, null=True, blank=True, related_name="costs"
    )
...
class Revenue(models.Model):
    ...
    field = models.ForeignKey(
        FieldData, on_delete=models.CASCADE, related_name="revenues"
    )
    season = models.ForeignKey(
        Season,
...
class GovernmentScheme(models.Model):
    ...
    max_land_acres = models.DecimalField(
        max_digits=8, decimal_places=2, null=True, blank=True
    )
    max_subsidy_amount = models.DecimalField(
...
class InsuranceClaim(models.Model):
    ...
    field = models.ForeignKey(
        FieldData, on_delete=models.CASCADE, related_name="insurance_claims"
    )
    season = models.ForeignKey(
        Season,
        on_delete=models.SET_NULL,
...
class FinanceTransaction(models.Model):
    """Unified financial ledger for the farm"""
    TRANSACTION_TYPES = [
        ("EXPENSE", "Expense"),
        ("INCOME", "Income"),
    ]
    ...
    user = models.ForeignKey(User, on_delete=models.CASCADE, related_name="finance_ledgers")
    field = models.ForeignKey(
        FieldData,
        on_delete=models.SET_NULL,
        null=True,
